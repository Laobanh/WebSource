...
namespace Web_SFH.Handlers
{
    ...
    public class Handler_MCSA5875 : IHttpHandler, IRequiresSessionState
    {
        ...
        public void ProcessRequest(HttpContext context)
        {
            ...
            mcsa.r1 = Lib.get_value_str(request["r1"]);
            mcsa.r2 = Lib.get_value_str(request["r2"]);
            mcsa.r3 = Lib.get_value_str(request["r3"]);
            mcsa.r4 = Lib.get_value_str(request["r4"]);
            mcsa.r5 = Lib.get_value_str(request["r5"]);
            mcsa.r6 = Lib.get_value_str(request["r6"]);
            mcsa.r7 = Lib.get_value_str(request["r7"]);
            mcsa.r8 = Lib.get_value_str(request["r8"]);
            mcsa.r9 = Lib.get_value_str(request["r9"]);
            mcsa.r10 = Lib.get_value_str(request["r10"]);
            mcsa.r11 = Lib.get_value_str(request["r11"]);
            mcsa.r12 = Lib.get_value_str(request["r12"]);
            mcsa.r13 = Lib.get_value_str(request["r13"]);
            mcsa.r13b = Lib.get_value_str(request["r13b"]);
            mcsa.r14 = Lib.get_value_str(request["r14"]);
            mcsa.r15 = Lib.get_value_str(request["r15"]);
            mcsa.r16 = Lib.get_value_str(request["r16"]);
            mcsa.r17 = Lib.get_value_str(request["r17"]);
            mcsa.r18 = Lib.get_value_str(request["r18"]);
            mcsa.r19 = Lib.get_value_str(request["r19"]);
            mcsa.r20 = Lib.get_value_str(request["r20"]);
            mcsa.r21 = Lib.get_value_str(request["r21"]);
            mcsa.r22 = Lib.get_value_str(request["r22"]);
            mcsa.r23 = Lib.get_value_str(request["r23"]);
            mcsa.r24 = Lib.get_value_str(request["r24"]);
            mcsa.r25 = Lib.get_value_str(request["r25"]);
            mcsa.r26 = Lib.get_value_str(request["r26"]);
            mcsa.r27 = Lib.get_value_str(request["r27"]);
            mcsa.r28 = Lib.get_value_str(request["r28"]);
            mcsa.r29 = Lib.get_value_str(request["r29"]);
            mcsa.r30 = Lib.get_value_str(request["r30"]);
